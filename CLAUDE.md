...
recall:
  search_vault → SENSE_documents_search (PostgreSQL tsvector/GIN, semantic via Qdrant when TEI available)
  search_sessions → SENSE_sessions_search (PostgreSQL tsvector/GIN + recency_bias)
