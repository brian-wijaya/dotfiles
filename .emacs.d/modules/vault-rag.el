...
(with-eval-after-load 'evil-leader
  (define-key bw/leader-v-map (kbd "i") 'bw/vault-rag-index)
  (define-key bw/leader-v-map (kbd "a") 'bw/vault-rag-auto)
  (define-key bw/leader-v-map (kbd "s") 'bw/vault-rag-status))
